...
//               <p className="text-sm text-gray-400 leading-relaxed text-center">
//                 Engineered with Server-Sent Events (SSE) for a seamless,
//                 "typing" effect. Get low-latency responses powered by the Gemini
//                 1.5 Flash model.
//               </p>
//             </div>
...
//               <p className="text-gray-400">Powered by Gemini 1.5 & RAG</p>
//             </div>
//             <ChatInterface />
//           </div>
//         </Show>
