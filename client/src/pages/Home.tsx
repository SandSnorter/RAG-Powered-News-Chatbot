  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-[20%] -left-[10%] w-[70vw] h-[70vw] max-w-[900px] max-h-[900px] rounded-full bg-purple-600/[0.07] blur-[120px] animate-glow-pulse" />
        <div className="absolute -bottom-[10%] -right-[10%] w-[60vw] h-[60vw] max-w-[800px] max-h-[800px] rounded-full bg-blue-600/[0.05] blur-[120px] animate-glow-pulse" style={{ animationDelay: "2s" }} />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <SignInButton mode="modal" forceRedirectUrl="/chat">
              <button className="px-4 py-2 text-sm font-medium text-[#8b949e] hover:text-white border border-white/10 hover:border-white/20 rounded-full transition-all">
                Sign In
              </button>
            </SignInButton>
            <SignUpButton mode="modal" forceRedirectUrl="/chat">
              <button className="px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-purple-600 to-blue-600 rounded-full hover:from-purple-500 hover:to-blue-500 transition-all shadow-lg shadow-purple-900/30">
                Get Started Free
              </button>
            </SignUpButton>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg text-[#8b949e] leading-relaxed mb-8 max-w-xl">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <SignUpButton mode="modal" forceRedirectUrl="/chat">
                  <button className="group flex items-center gap-2 px-6 py-3.5 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold rounded-full hover:from-purple-500 hover:to-blue-500 transition-all shadow-lg shadow-purple-900/40">
                    Start for Free
                    <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                  </button>
                </SignUpButton>
                <a href="#pipeline" className="flex items-center gap-1.5 text-sm text-[#8b949e] hover:text-white transition-colors">
            ...
            <div className="flex-1 w-full max-w-lg animate-float">
              <div className="glass rounded-2xl overflow-hidden shadow-2xl shadow-black/60">
                <div className="flex items-center gap-2.5 px-5 py-3.5 border-b border-white/[0.06] bg-white/[0.015]">
                  ...
                  <span className="text-xs font-medium text-[#8b949e]">Nexus Intelligence</span>
                  <span className="ml-auto text-xs text-[#484f58]">Gemini 2.5 · RAG</span>
                </div>
                <div className="p-5 space-y-4">
                  <div className="flex justify-end">
                    <div className="max-w-[80%] px-4 py-2.5 bg-gradient-to-br from-purple-600 to-purple-700 rounded-2xl rounded-tr-sm text-sm text-white shadow-md">
                      What happened with Apple and the EU today?
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <div className="w-7 h-7 rounded-full bg-gradient-to-br from-purple-500 to-blue-600 flex items-center justify-center flex-shrink-0 mt-0.5 shadow-lg shadow-purple-900/40">
                      <Globe className="w-3.5 h-3.5 text-white" />
                    </div>
                    <div className="flex-1 px-4 py-3 glass-surface rounded-2xl rounded-tl-sm text-sm">
                      <p className="text-[#f0f6fc] font-medium mb-2">Based on retrieved articles:</p>
                      <ul className="space-y-1.5 text-xs text-[#8b949e]">
                        <li className="flex gap-2"><span className="text-purple-400 mt-0.5 flex-shrink-0">•</span>Apple faces €500M fine under EU Digital Markets Act</li>
                        <li className="flex gap-2"><span className="text-purple-400 mt-0.5 flex-shrink-0">•</span>App Store interoperability requirements take effect</li>
                        <li className="flex gap-2"><span className="text-purple-400 mt-0.5 flex-shrink-0">•</span>Apple appeals decision, citing security concerns</li>
                      </ul>
                      <div className="mt-3 flex items-center gap-2">
                        ...
                        <span className="text-[10px] text-[#484f58]">Sourced from 3 articles</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="px-5 py-4 border-t border-white/[0.06] bg-black/20">
                  <div className="flex items-center gap-3 px-4 py-2.5 bg-white/[0.04] border border-white/[0.07] rounded-full">
                    <span className="text-sm text-[#484f58] flex-1">Ask about today&#39;s news...</span>
      ...
      {/* Stats */}
      <section className="py-8 border-y border-white/[0.05] bg-white/[0.008]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {STATS.map((s) => (
              <div key={s.label} className="text-center">
                <div className="text-3xl font-bold gradient-text-purple">{s.value}</div>
                <div className="text-xs text-[#484f58] mt-1.5 font-medium uppercase tracking-widest">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="features" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.04] border border-white/[0.08] text-[#8b949e] text-xs font-medium mb-4">
              <Layers className="w-3.5 h-3.5" /> Engineering Excellence
            </div>
            <h2 className="text-4xl font-bold mb-4 text-[#f0f6fc]">Built for precision, not magic</h2>
            <p className="text-[#8b949e] max-w-xl mx-auto">Every component is purpose-built. Observable, deterministic, and production-grade.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {FEATURES.map((f) => (
              <div key={f.title} className={`glass-card rounded-2xl p-6 bg-gradient-to-br ${f.color} border border-white/[0.06] ${f.border} transition-all duration-300`}>
                <div className={`w-10 h-10 ${f.iconBg} rounded-xl flex items-center justify-center mb-4`}>
                  <f.icon className={`w-5 h-5 ${f.iconColor}`} />
                </div>
                <h3 className="font-semibold text-[#f0f6fc] mb-2">{f.title}</h3>
      ...
      <section id="pipeline" className="py-24 px-6 border-t border-white/[0.04]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-[#f0f6fc] mb-4">From question to answer in milliseconds</h2>
            <p className="text-[#8b949e] max-w-xl mx-auto">A fully observable pipeline. No black boxes.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {STEPS.map((step, idx) => (
              <div key={step.step} className="relative">
                {idx < STEPS.length - 1 && (
                  <div className="hidden lg:block absolute top-8 left-[calc(50%+32px)] right-[-50%] h-px bg-gradient-to-r from-purple-500/30 to-transparent" />
                )}
                <div className="glass-card rounded-2xl p-6 text-center border border-white/[0.06] hover:border-purple-500/20 transition-all">
                  <div className="w-12 h-12 mx-auto rounded-2xl bg-gradient-to-br from-purple-600/20 to-blue-600/20 border border-purple-500/20 flex items-center justify-center mb-4">
                    <step.icon className="w-5 h-5 text-purple-400" />
                  </div>
                  <div className="text-xs font-mono text-purple-500 mb-1">{step.step}</div>
                  <h3 className="font-semibold text-[#f0f6fc] mb-2">{step.title}</h3>
      ...
      {/* Tech Stack */}
      <section id="tech" className="py-16 px-6 border-t border-white/[0.04]">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-xs font-medium uppercase tracking-widest text-[#484f58] mb-8">Powered by industry-leading technology</p>
          <div className="flex flex-wrap justify-center gap-3">
            {TECH.map((t) => (
              <div key={t.name} className="px-4 py-2 rounded-full glass-surface border border-white/[0.07] text-sm font-medium text-[#8b949e] hover:text-white hover:border-white/20 transition-all cursor-default">
      ...
      <section className="py-24 px-6 border-t border-white/[0.04]">
        <div className="max-w-3xl mx-auto text-center">
          <div className="glass-card rounded-3xl p-12 border border-white/[0.08] relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-purple-600/10 to-blue-600/10 pointer-events-none" />
            <h2 className="relative text-4xl font-bold text-[#f0f6fc] mb-4">Ready to get smarter<br />about the news?</h2>
            <p className="relative text-[#8b949e] mb-8 max-w-md mx-auto">Join Nexus and get factual, sourced, AI-powered answers — free, forever.</p>
            <SignUpButton mode="modal" forceRedirectUrl="/chat">
              <button className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold rounded-full hover:from-purple-500 hover:to-blue-500 transition-all shadow-xl shadow-purple-900/40 text-base">
      ...
      <footer className="border-t border-white/[0.04] py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-[#484f58]">RAG-Powered News Intelligence · Built with Gemini 2.5, Qdrant &amp; Jina AI</p>
        </div>
      </footer>
    </div>
  );
